...
# b_jd8 = Day.create(date: Date.new(2020,1,8), mood_score: 6, sleep_hours: 7, user: billy)
# b_jd9 = Day.create(date: Date.new(2020,1,9), mood_score: 10, sleep_hours: 8, user: billy)
# b_jd10 = Day.create(date: Date.new(2020,1,10), mood_score: 3, sleep_hours: 9, user: billy)
# b_jd11 = Day.create(date: Date.new(2020,1,11), mood_score: 4, sleep_hours: 10, user: billy)
# b_jd12 = Day.create(date: Date.new(2020,1,12), mood_score: 9, sleep_hours: 8, user: billy)
# b_jd13 = Day.create(date: Date.new(2020,1,13), mood_score: 7, sleep_hours: 7, user: billy)
# b_jd14 = Day.create(date: Date.new(2020,1,14), mood_score: 8, sleep_hours: 5, user: billy)
# b_jd15 = Day.create(date: Date.new(2020,1,15), mood_score: 2, sleep_hours: 4, user: billy)
# b_jd16 = Day.create(date: Date.new(2020,1,16), mood_score: 1, sleep_hours: 7, user: billy)
# b_jd17 = Day.create(date: Date.new(2020,1,17), mood_score: 3, sleep_hours: 8, user: billy)
# b_jd18 = Day.create(date: Date.new(2020,1,18), mood_score: 4, sleep_hours: 9, user: billy)
# b_jd19 = Day.create(date: Date.new(2020,1,19), mood_score: 8, sleep_hours: 10, user: billy)
# b_jd20 = Day.create(date: Date.new(2020,1,20), mood_score: 7, sleep_hours: 4, user: billy)
# b_jd21 = Day.create(date: Date.new(2020,1,21), mood_score: 7, sleep_hours: 6, user: billy)
# b_jd22 = Day.create(date: Date.new(2020,1,22), mood_score: 7, sleep_hours: 7, user: billy)
# b_jd23 = Day.create(date: Date.new(2020,1,23), mood_score: 8, sleep_hours: 8, user: billy)
# b_jd24 = Day.create(date: Date.new(2020,1,24), mood_score: 9, sleep_hours: 4, user: billy)
# b_jd25 = Day.create(date: Date.new(2020,1,25), mood_score: 5, sleep_hours: 8, user: billy)
# b_jd26 = Day.create(date: Date.new(2020,1,26), mood_score: 6, sleep_hours: 8, user: billy)
# b_jd27 = Day.create(date: Date.new(2020,1,27), mood_score: 4, sleep_hours: 8, user: billy)
# b_jd28 = Day.create(date: Date.new(2020,1,28), mood_score: 4, sleep_hours: 8, user: billy)
# b_jd29 = Day.create(date: Date.new(2020,1,29), mood_score: 5, sleep_hours: 5, user: billy)
# b_jd30 = Day.create(date: Date.new(2020,1,30), mood_score: 6, sleep_hours: 6, user: billy)
# b_jd31 = Day.create(date: Date.new(2020,1,31), mood_score: 10, sleep_hours: 6, user: billy)
