...
#day seeds
b_d1 = Day.create(date: "11/01/2020", mood_score: 3, sleep_hours: 5, user: billy)
b_d2 = Day.create(date: "11/02/2020", mood_score: 4, sleep_hours: 6, user: billy)
b_d3 = Day.create(date: "11/03/2020", mood_score: 5, sleep_hours: 7, user: billy)
b_d4 = Day.create(date: "11/04/2020", mood_score: 6, sleep_hours: 8, user: billy)
b_d5 = Day.create(date: "11/05/2020", mood_score: 7, sleep_hours: 9, user: billy)
b_d6 = Day.create(date: "11/06/2020", mood_score: 8, sleep_hours: 4, user: billy)
b_d7 = Day.create(date: "11/07/2020", mood_score: 9, sleep_hours: 5, user: billy)
b_d8 = Day.create(date: "11/08/2020", mood_score: 10, sleep_hours: 7, user: billy)
b_d9 = Day.create(date: "11/09/2020", mood_score: 1, sleep_hours: 8, user: billy)
b_d10 = Day.create(date: "11/10/2020", mood_score: 2, sleep_hours: 9, user: billy)
b_d11 = Day.create(date: "11/11/2020", mood_score: 3, sleep_hours: 10, user: billy)
b_d12 = Day.create(date: "11/12/2020", mood_score: 4, sleep_hours: 8, user: billy)
b_d13 = Day.create(date: "11/13/2020", mood_score: 5, sleep_hours: 7, user: billy)
b_d14 = Day.create(date: "11/14/2020", mood_score: 6, sleep_hours: 5, user: billy)
b_d15 = Day.create(date: "11/15/2020", mood_score: 7, sleep_hours: 4, user: billy)
b_d16 = Day.create(date: "11/16/2020", mood_score: 8, sleep_hours: 7, user: billy)
b_d17 = Day.create(date: "11/17/2020", mood_score: 9, sleep_hours: 8, user: billy)
b_d18 = Day.create(date: "11/18/2020", mood_score: 10, sleep_hours: 9, user: billy)
b_d19 = Day.create(date: "11/19/2020", mood_score: 3, sleep_hours: 10, user: billy)
b_d20 = Day.create(date: "11/20/2020", mood_score: 4, sleep_hours: 4, user: billy)
b_d21 = Day.create(date: "11/21/2020", mood_score: 5, sleep_hours: 6, user: billy)
b_d22 = Day.create(date: "11/22/2020", mood_score: 6, sleep_hours: 7, user: billy)
b_d23 = Day.create(date: "11/23/2020", mood_score: 7, sleep_hours: 8, user: billy)
b_d24 = Day.create(date: "11/24/2020", mood_score: 8, sleep_hours: 4, user: billy)
b_d25 = Day.create(date: "11/25/2020", mood_score: 9, sleep_hours: 8, user: billy)
b_d26 = Day.create(date: "11/26/2020", mood_score: 10, sleep_hours: 8, user: billy)
b_d27 = Day.create(date: "11/27/2020", mood_score: 3, sleep_hours: 8, user: billy)
b_d28 = Day.create(date: "11/28/2020", mood_score: 4, sleep_hours: 8, user: billy)
b_d29 = Day.create(date: "11/29/2020", mood_score: 1, sleep_hours: 5, user: billy)
